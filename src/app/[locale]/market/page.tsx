...
export default async function MarketPage({ params, searchParams }: { params: Promise<{ locale: string }>; searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  const copy = locale === "zh-Hant" ? { eyebrow: "角色場刊索引", title: "慢慢逛，找到今天想帶回房間的角色。", body: "可以從作品季別、角色氣質、陪伴需求或素材來源開始，也可以直接看看最近收到最多心意的角色。", searchLabel: "關鍵字", tagLabel: "角色標籤", sourceLabel: "素材來源", seasonLabel: "作品季別", moodLabel: "陪伴氣質", search: "搜尋角色、作品或關鍵字", tag: "例如：安慰、冷靜", allRights: "所有來源", original: "原創角色", metadata: "資料型角色", allSeasons: "所有季別", allMoods: "所有氣質", sortSupport: "24 小時應援熱度", sortQuote: "目前價格", sortNew: "最新上架", watching: "只看關注中", apply: "看看結果", found: `找到 ${cards.length} 個角色`, empty: "這組條件還在等合適的角色，換個標籤再逛逛吧。", tape: "今日心意動態", unit: "SUP / 份", fans: "位新應援者" } : { eyebrow: "Character catalog index", title: "Take your time and find someone to bring into your room today.", body: "Begin with season, character mood, kind of company, or media source, then see who has been receiving affection lately.", searchLabel: "Keyword", tagLabel: "Character tag", sourceLabel: "Source lane", seasonLabel: "Release season", moodLabel: "Comfort mood", search: "Search character, series, or keyword", tag: "e.g. comfort, calm", allRights: "All source types", original: "Original characters", metadata: "Metadata signals", allSeasons: "All seasons", allMoods: "All moods", sortSupport: "24h support activity", sortQuote: "Current quote", sortNew: "Newest listing", watching: "Watching only", apply: "See results", found: `${cards.length} characters`, empty: "This set of filters is still waiting for the right character. Try another tag and keep browsing.", tape: "Today's affection feed", unit: "SUP / unit", fans: "new supporters" };
