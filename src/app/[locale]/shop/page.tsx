...
export default async function ShopPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const copy = locale === "zh-Hant" ? { eyebrow: "ACG ROOM BOOTH", title: "把今天的喜歡穿進自己的房間。", body: "用 SUP 帶回頭像框、玩家房間主題與 AI 原創壁紙，替收藏櫃換上一個更像你的版本。", wallet: "可用 SUP", original: "原創與 AI 友善素材", noPower: "房間外觀收藏" } : { eyebrow: "ACG ROOM BOOTH", title: "Wear today's affection inside your own room.", body: "Use SUP for avatar frames, player-room themes, and original AI-friendly wallpapers, then give the collection shelf an edition that feels like you.", wallet: "Available SUP", original: "Original & AI-friendly assets", noPower: "Room appearance collection" };
